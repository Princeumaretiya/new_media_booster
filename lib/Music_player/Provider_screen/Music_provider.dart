...
class Music_provider extends ChangeNotifier {
  List<Music_model> musicList = [
    Music_model(
      img: "assets/image/Music_home/m1.png",
      name: "Tara nano mane rang",
      singar: "Om Baraiya",
    ),
    Music_model(
      img: "assets/image/Music_home/m2.png",
      name: "Mara malk na mena rani",
      singar: "Jignesh Kaviraj",
    ),
    Music_model(
      img: "assets/image/Music_home/m3.png",
      name: "Pa Pa pagli",
      singar: "Sonu nigam",
    ),
    Music_model(
      img: "assets/image/Music_home/m4.png",
      name: "Bhamariyalo",
      singar: "Umesh Barot",
    ),
    Music_model(
      img: "assets/image/Music_home/m5.png",
      name: "JAnat ve",
      singar: "Darshan Raval",
    ),
    Music_model(
      img: "assets/image/Music_home/m6.png",
      name: "Tane Joye me jyarthi",
      singar: "Umesh Barot",
    ),
